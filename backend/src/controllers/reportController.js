import { Order, Product, Category } from '../models/index.js';
...
export async function summary(req, res) {
  ...
  res.json({
    ...
    sales: {
      ...
      marginPercent: revenue ? round2(((revenue - cogs) / revenue) * 100) : 0,
...
export async function exportData(req, res) {
  ...
  res.json({
    ...
    totals: {
      ...
      revenue: round2(orderRows.reduce((s, r) => s + r.grandTotal, 0)),
      profit: round2(orderRows.reduce((s, r) => s + (r.grandTotal - r.cogs), 0)),
    },
    orders: orderRows,
    items: itemRows,
  });
