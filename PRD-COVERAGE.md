...
|---|---|---|
| `npm test` | 255 | The whole API against a real MongoDB |
...
App end-to-end — need the backend on :5000 and a web export served on :8099:
...
Plus nine further browser suites covering auth, deletes, logout, photos,
previews, the admin cascade, sales editing, and the reported-bug regressions.
