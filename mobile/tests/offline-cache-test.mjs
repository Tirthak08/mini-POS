...
/**
 * Sign-out moved out of the header and into Settings, which is reached by
 * tapping the shop's own name -- so getting there is now two taps plus the
 * confirmation. The chip is addressed by the shop name rather than by the word
 * "Settings", which is translated.
 */
await page.getByRole('button', { name: new RegExp(shopA) }).last().click();
